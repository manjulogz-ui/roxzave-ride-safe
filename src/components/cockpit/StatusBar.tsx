  ...
  return (
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <Link to="/safety-center" className="leading-tight">
      ...
      <div className="flex items-center gap-2">
        <Link to="/notifications" className="glass relative grid h-10 w-10 place-items-center rounded-xl">
          <Bell className="h-4 w-4 text-foreground/80" />
          <span className="absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full bg-emergency shadow-[0_0_8px_var(--emergency-glow)]" />
        </Link>
        <Link to="/profile" className="glass grid h-10 w-10 place-items-center rounded-xl">
